...
proc isBmp*(buf: seq[byte]): tuple[extension, mime: string] =
  if buf.len > 1 and
  buf[0] == 0x42 and
  buf[1] == 0x4D:
...
proc isCr2*(buf: seq[byte]): tuple[extension, mime: string] =
  if buf.len > 9 and
  ((buf[0] == 0x49 and
    buf[1] == 0x49 and
    buf[2] == 0x2A and
...
proc isDcm*(buf: seq[byte]): tuple[extension, mime: string] =
 const offset = 128
...
proc isGif*(buf: seq[byte]): tuple[extension, mime: string] =
  if len(buf) > 2 and
  buf[0] == 0x47 and
  buf[1] == 0x49 and
  buf[2] == 0x46:
...
proc isJpeg*(buf: seq[byte]): tuple[extension, mime: string] =
  if buf.len > 2 and
  buf[0] == 0xFF and
  buf[1] == 0xD8 and
  buf[2] == 0xFF:
...
proc isJpx*(buf: seq[byte]): tuple[extension, mime: string] =
  if buf.len > 50 and
  buf[0] == 0x00 and
  buf[1] == 0x00 and
  buf[2] == 0x00 and
...
proc isJxr*(buf: seq[byte]): tuple[extension, mime: string] =
  if buf.len > 2 and
  buf[0] == 0x49 and
  buf[1] == 0x49 and
  buf[2] == 0xBC:
...
proc isPng*(buf: seq[byte]): tuple[extension, mime: string] =
  if buf.len > 3 and
  buf[0] == 0x89 and
  buf[1] == 0x50 and
  buf[2] == 0x4E and
...
proc isPsd*(buf: seq[byte]): tuple[extension, mime: string] =
  if buf.len > 3 and
  buf[0] == 0x38 and
  buf[1] == 0x42 and
  buf[2] == 0x50 and
...
proc isTiff*(buf: seq[byte]): tuple[extension, mime: string] =
  if buf.len > 3 and
  ((buf[0] == 0x49 and
    buf[1] == 0x49 and
    buf[2] == 0x2A and
...
proc isWebp*(buf: seq[byte]): tuple[extension, mime: string] =
  if len(buf) > 13 and
  buf[0] == 0x52 and
  buf[1] == 0x49 and
  buf[2] == 0x46 and
